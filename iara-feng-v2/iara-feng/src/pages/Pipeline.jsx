...
export default function Pipeline() {
  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#0D0A14', color: '#F0E8FF', fontFamily: "'Inter',system-ui,sans-serif" }}>
      ...
      {/* Header */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 20px', borderBottom: '1px solid #1E1433', background: 'linear-gradient(180deg,#0F0B1A,#0A0810)', boxShadow: '0 2px 12px rgba(0,0,0,0.4)', position: 'sticky', top: 0, zIndex: 10 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: '#6B5A90' }}>{ativos.length} leads ativos</div>
          </div>
        </div>
